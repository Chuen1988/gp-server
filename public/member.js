...
<div class="card w-full max-w-sm bg-base-100 px-4 py-8 shadow-xl">
  ...
  <form class="card-body pt-2">
    ...
    <div class="form-control">
      <label for="contactNumber" class="label"><span class="label-text">Contact Number</span></label>
      <input type="text" name="contactNumber" placeholder="Enter contact number" class="input input-bordered">
    </div>
    ...
    userList.innerHTML += `<li class="user">
      <a>
        <div class="avatar indicator">
          <div class="w-6 rounded"><img src="logo.png" alt="${user.contactNumber}"></div>
        </div><span>${user.contactNumber}</span>
      </a>
    </li>`
...
// Retrieve contactNumber/password/company object from the login/signup page
...
// Log in either using the given contactNumber/password/company or the token from storage
